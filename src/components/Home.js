...
const Home = () => {
  return (
    ...
    <main role="main"  style={{padding:'2vh',backgroundImage:`url(${image})`}}>
        ...
        <h1 className="display-1 cover-heading mozart-inner" style={{fontWeight:'bold',fontFamily: 'Inter'}} >D M S B G 100</h1>
    ...
    <div>
      <p className="lead" style={{fontFamily: 'Quicksand',backgroundColor:'rgb(216, 216, 216,0.2)',paddingLeft:'5em',paddingRight:'5em',paddingTop:'5em',paddingBottom:'5em'}}>In today's hyper-connected digital landscape, businesses require dynamic, versatile, and secure networking solutions that not only meet the demands of the present but are also future-ready. Addressing this, we unveil the apex of networking innovation—the Difuse  Multiservice Business Gateway (DMSBG 100).
...
The MBG isn’t just another router; it's a comprehensive fusion of the most sought-after networking tools and technologies, consolidated within a single, state-of-the-art device. </p>
    ...
    <main role="main"  style={{paddingTop:'10rem',paddingBottom:'5rem',backgroundImage:`url(${image})`}}>
        ...
        <h1 className="display-1 cover-heading mozart-inner" style={{fontWeight:'bold',fontFamily: 'Inter'}} >D P B X 50</h1>
        ...
        <p className="lead" style={{fontFamily: 'Quicksand'}}>In the realm of digital connectivity, the Difuse Business Gateway stands out not just for its robust VPN technologies and security features, but also for its integration of the Asterisk telephony system. This powerful combination provides businesses with an unparalleled communication infrastructure, merging traditional telephony with modern digital needs. Here's how Asterisk enriches the Difuse platform:
</p>
        <p className="lead" style={{fontFamily: 'Quicksand'}}>
