...
import brochure from '../assets/files/DPBX-50 Brochure.pdf'
const Download = () => {
  return (
    <div>
      ...
      {/* backgroundColor: 'rgb(215, 228, 237,0.7)' */}
         ...
         <Accordion  className='ms-5 me-5 mb-0' >
      ...
      <Accordion.Item eventKey="1"  className='m-2'>
        ...
        <ul style={{listStyle:'none'}}>
            ...
            <li className='m-2'><a href={brochure} target="_blank" rel="noopener noreferrer" style={{textDecoration:'none',color:'black'}}>DPBX-50-Brochure<i className="fa-solid fa-arrow-up fa-sm m-2" style={{color:'#000',rotate:'45deg'}}></i></a></li>
      ...
      <Accordion.Item eventKey="2"  className='m-2'>
        ...
        <Accordion.Body>
        <ul style={{listStyle:'none'}}>
            <li className='m-2'><a href='https://docs.difuse.io/' target="_blank" rel="noopener noreferrer" style={{textDecoration:'none',color:'black'}}>DMSBG 100<i className="fa-solid fa-arrow-up fa-sm m-2" style={{color:'#000',rotate:'45deg'}}></i></a></li>
          </ul>
        </Accordion.Body>
      </Accordion.Item>
    </Accordion>
